...
// Get the archive title based on context
...
<!-- ========================================
     HERO SECTION
     ======================================== -->
<section class="ehs-insights-hero">
    ...
    <div class="container">
        ...
        <?php if (have_posts()): ?>
            <div class="ehs-posts-grid">
                ...
                while (have_posts()):
                    the_post();
                    // Skip the featured post if on home page
                    if (is_home() && $featured_post && get_the_ID() === $featured_post->ID) {
                        continue;
                    }
                ?>
