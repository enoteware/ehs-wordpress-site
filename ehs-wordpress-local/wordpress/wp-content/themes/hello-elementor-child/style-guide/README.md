...
**This folder (in the child theme) is the single source of truth.** The WordPress admin Style Guide page (`wp-admin → Style Guide`) loads `style-guide.html` from here. Edit files in this folder to update the design system; agents and developers are instructed to use this location.
